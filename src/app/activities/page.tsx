    ...
    <div className="min-h-screen">
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
          ...
          {activeTab === "care" && (
            <div className="mt-12 relative overflow-hidden rounded-2xl bg-gradient-to-br from-amber-50 via-orange-50 to-red-50 border border-amber-200/60">
              {/* 배경 장식 */}
                ...
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
                  <div className="flex-1">
                    ...
                    <p className="text-gray-600 text-sm md:text-base leading-relaxed max-w-xl">
                      긴급하게 심리상담 연계가 필요한 아동을 위해 빠른 의뢰
                      채널을 운영하고 있습니다. 아래 버튼을 통해 즉시 의뢰서를
                      작성하실 수 있습니다.
                    </p>
                  </div>
